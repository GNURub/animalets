...
const PetManager: FunctionalComponent<PetManagerProps> = ({ initialPets, userId }) => {
    ...
    const handleSubmit = async (e: Event) => {
        ...
        try {
            ...
            alert(error instanceof Error ? error.message : 'Error al guardar mascota');
        } finally {
        ...
        <div>
            ...
            {pets.length === 0 ? (
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {pets.map(pet => (
                        <div key={pet.id} class="card hover:shadow-lg transition-shadow">
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex items-center">
                                    <span class="text-4xl mr-3">{getSpeciesIcon(pet.species)}</span>
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900">{pet.name}</h3>
                                        <p class="text-sm text-gray-500">{pet.breed || 'Sin raza especificada'}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2 mb-4">
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span class="font-medium">{getAgeString(pet.birth_date)}</span>
                                </div>
                                {pet.weight && (
                                    <div class="flex justify-between text-sm">
                        ...
                        <form onSubmit={handleSubmit} class="space-y-4">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setFormData({ ...formData, species: (e.target as HTMLSelectElement).value as 'dog' | 'cat' | 'other' })}
                                >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onInput={(e) => setFormData({ ...formData, breed: (e.target as HTMLInputElement).value })}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onInput={(e) => setFormData({ ...formData, birth_date: (e.target as HTMLInputElement).value })}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onInput={(e) => setFormData({ ...formData, weight: (e.target as HTMLInputElement).value })}
                                />
                            </div>
