...
const ServiceManager: FunctionalComponent<ServiceManagerProps> = ({ initialServices }) => {
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {services.map(service => (
                    <div key={service.id} class={`card ${!service.is_active ? 'opacity-60' : ''}`}>
                        ...
                        <div class="space-y-2 mb-4">
                            ...
                            <div class="flex justify-between text-sm">
                                ...
                                <span class="font-bold text-green-600 text-lg">€{service.price.toFixed(2)}</span>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} class="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onInput={(e) => setFormData({ ...formData, duration_minutes: (e.target as HTMLInputElement).value })}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onInput={(e) => setFormData({ ...formData, price: (e.target as HTMLInputElement).value })}
                                />
                            </div>
